...
public class KeyboardHook : IDisposable
{
    ...
    private void SetParameters(Parameters param)
    {
        switch (param)
        {
            ...
            case Parameters.AllowWindowsKey:
                Console.WriteLine("tasto windows key abilitato");
    ...
    /// </summary>
    /// 
    Int32 past=0, past2 = 0;
    private IntPtr HookCallback(
        int nCode, IntPtr wParam, ref KBDLLHOOKSTRUCT lParam)
    {
        AllowKey = PassAllKeysToNextApp;
    //    Console.WriteLine(lParam.flags);
    //    Console.WriteLine(lParam.vkCode);
                ...
                switch (lParam.flags)
                {
                    ...
                    case 129:
                        if ((lParam.vkCode == 91) || (lParam.vkCode == 92))
                            AllowKey = false;
                        Console.WriteLine("hai premuto windows");
                        break;
                }
            }
            ...
            if (((lParam.vkCode == 9) && (lParam.flags == 32)) ||
                    ...
                    (lParam.flags == 32)) || ((lParam.vkCode == 73) && (lParam.flags == 0)))
            {
                AllowKey = false;
            }
            ...
            OnKeyIntercepted(new KeyboardHookEventArgs(lParam.vkCode, AllowKey,wParam));
    ...
    public class KeyboardHookEventArgs : System.EventArgs
    {
        ...
        public KeyboardHookEventArgs(int evtKeyCode, bool evtPassThrough,IntPtr evtwParam)
        {
